...
function Home() {
  ...
  const products = [
    ...
    { category: "products", name: "UPRESS Tubler", description: "Soft cotton t-shirt", image: "/Products/Customize Tubler.jpg", price: 60 },
    { category: "services", name: "Printing ", description: "High-quality printing services for flyers, brochures, posters, and more. Pricing depends on color choice, size, and quantity of the order. *This service is available by appointment only.*", image: "/OfferServices/Printing.jpg", },
    { category: "services", name: "Layout", description:  "Professional layout and design for academic books, magazines, and promotional materials. Pricing varies based on complexity and page count. *This service is available by appointment only.*", image: "/OfferServices/Layout.jpg",  },
    { category: "services", name: "BookBind", description: "Durable and elegant bookbinding services for theses, journals, and publications. Pricing is based on binding type, number of pages, and size. *This service is available by appointment only.*", image: "/OfferServices/BookBind.jpg", },
...
<section
  id="Home"
  className="bg-center bg-cover bg-[url('/images/wmsu.jpg')] bg-gray-600 bg-blend-multiply"
>
